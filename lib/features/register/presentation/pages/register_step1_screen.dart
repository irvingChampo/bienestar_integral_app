...
class _RegisterStep1ScreenState extends State<RegisterStep1Screen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      // 1. Resetear el formulario para evitar datos viejos
      context.read<RegisterProvider>().resetForm();

      // 2. Verificar si venimos de Google Login con datos pre-llenados
      ...
      if (extra != null && extra is Map<String, dynamic>) {
        setState(() {
          // Pre-llenar Email
          if (extra['email'] != null) {
            _emailCtrl.text = extra['email'];
          }

          // Pre-llenar Nombre
          if (extra['names'] != null) {
            _namesCtrl.text = extra['names'];
          }
        });
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: const Text('¡Hola! Completa tus datos para terminar el registro.'),
            ...
            child: Column(
              ...
              children: [
                ...
                CustomTextField(
                  ...
                  // Opcional: Si quieres que el email de Google sea de solo lectura
                  // readOnly: _emailCtrl.text.isNotEmpty,
